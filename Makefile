...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Tue Apr 23 13:56:31 2013
...
SOURCES       = charizard.cpp \
		...
		GraphicWindow.cpp \
		mainwindow.cpp \
		qtpuzzle.cpp moc_GraphicWindow.cpp \
		moc_mainwindow.cpp
OBJECTS       = charizard.o \
		game.o \
		GraphicWindow.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/game_jacksocd1.0.0/ && $(COPY_FILE) --parents charizard.h GraphicWindow.h mainwindow.h .tmp/game_jacksocd1.0.0/ && $(COPY_FILE) --parents charizard.cpp game.cpp GraphicWindow.cpp mainwindow.cpp qtpuzzle.cpp .tmp/game_jacksocd1.0.0/ && (cd `dirname .tmp/game_jacksocd1.0.0` && $(TAR) game_jacksocd1.0.0.tar game_jacksocd1.0.0 && $(COMPRESS) game_jacksocd1.0.0.tar) && $(MOVE) `dirname .tmp/game_jacksocd1.0.0`/game_jacksocd1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/game_jacksocd1.0.0
