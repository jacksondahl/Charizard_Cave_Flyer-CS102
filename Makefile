...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Mon Apr 29 08:21:27 2013
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/game_jacksocd1.0.0/ && $(COPY_FILE) --parents charizard.h feraligatr.h fireball.h GraphicWindow.h mainwindow.h mylist.h spikes.h thing.h .tmp/game_jacksocd1.0.0/ && $(COPY_FILE) --parents charizard.cpp feraligatr.cpp fireball.cpp game.cpp GraphicWindow.cpp mainwindow.cpp spikes.cpp thing.cpp .tmp/game_jacksocd1.0.0/ && (cd `dirname .tmp/game_jacksocd1.0.0` && $(TAR) game_jacksocd1.0.0.tar game_jacksocd1.0.0 && $(COMPRESS) game_jacksocd1.0.0.tar) && $(MOVE) `dirname .tmp/game_jacksocd1.0.0`/game_jacksocd1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/game_jacksocd1.0.0
